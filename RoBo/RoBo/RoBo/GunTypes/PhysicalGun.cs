...
namespace RoBo
{
    ...
    {
        public PhysicalGun(Character character, WeaponType wepType, Texture2D texture, float scaleFactor, int damage, float accuracy, float reloadSpd, float fireRate, float range,
